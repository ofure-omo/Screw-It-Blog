...
<body> <div style="min-height: 0vh;">
    ...
    <?php if ($blog['layout'] == '1' && $blog['published'] === 'published'): ?>
        <div class='read-header'>
            ...
            <div id="social-media" style="display:inline-block; "> <!--retrieve url links from user table-->
                ...
                <?php if (isset($_SESSION['loggedin']) && $fav_count === '0'): ?>
                    ...
                    </a><span class="like-text" ><?php echo $likes; ?></span>
                <?php endif; ?>
                ...
                <?php if (!isset($_SESSION['loggedin'])): ?>
                    ...
                    <span class="like-text" ><?php echo $likes; ?></span>
                <?php endif; ?>
            </div>
        ...
        <div class='read-blog-container'>
            ...
            <div class="row row-cols-1 row-cols-md-3 more-container" style="">
                <?php foreach ($list as $card): ?>
                    ...
                    <div class='col mb-4' >
                        <div class='card h-100 more-card' id="more-onhover">
                            <a href='?controller=blog&action=read&blog_id=<?= $card['blog_id'] ?>'>
                                <img style='  height: 250px; width:570px; object-fit: cover;' class='card-img-top' src="<?= $card['third_image'] ?>" alt="<?= $card['title'] ?>">
                            </a>
                            <div style="text-align:center;" class='card-body more-title'>
                ...
                <div class='comment-container'>
                    <form method='POST' id='comment_form' accept-charset="utf-8" enctype="multipart/form-data">
                        ...
                        <div class='form-group'>
                            ...
                            <input style="float: right;" type='submit' name='submit' id='submit' class='btn ' value='Submit'/>
                        </div>
                    </form>
