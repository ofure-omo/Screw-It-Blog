...
<?php if ($blog['layout'] === '2' && $blog['published'] === 'published'): ?>
            ...
            <div class='read-header'>
                ...
                <div id="social-media" style="dispaly:inline-block; "> <!--retrieve url links from user table-->
                    ...
                    <?php if (isset($_SESSION['loggedin']) && $fav_count === '0'): ?>
                        ...
                        </a><span class="like-text" style=" font-size:0.65em;"><?php echo $likes; ?></span>
                    <?php endif; ?>
                    ...
                    <?php if (!isset($_SESSION['loggedin'])): ?>
                        ...
                        <span class="like-text" style="font-size:0.65em;"><?php echo $likes; ?></span>
                    <?php endif; ?>
                </div>
    ...
    <?php foreach ($list as $card): ?>
                ...
                <!--        COMMENTS-->
                <center> <h5 style="margin-top:40px;"><?php // echo $comment_count;  ?> COMMENTS</h5></center>
