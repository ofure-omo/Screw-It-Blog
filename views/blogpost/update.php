...
/*        .form-container{
    ...
    <span>
        ...
        <div class=' form-container'>
            <form action="" method="POST" class="w3-container" enctype="multipart/form-data">
                    <h2 class="title">STEP 1: CHOOSE A NEW LAYOUT?</h2>
        <div class="layout">
        ...
        <div id="template-container" class="column">              
            <img src="views/images/layout.png" alt="layout 1" class="blog-template1"/>
                    ...
                    <h2 class="title">STEP 2: REWRITE THE CONTENT</h2>
                    <div class="main-form">
                ...
                <div class="form-group" id='body1'>
                    ...
                    <textarea class="form-control" id="exampleFormControlTextarea1" name="body" rows="20" placeholder="Body text" required><?= $blog['body']; ?></textarea>
                </div>
                <div class="form-group hide" id="body2">
                    <label for="exampleFormControlTextarea1"><p><b>BODY 2</b></p></label>
                    <textarea class="form-control" id="exampleFormControlTextarea1" name="body2" rows="10" placeholder="Body text" ><?= $blog['body2']; ?></textarea>
                </div>
