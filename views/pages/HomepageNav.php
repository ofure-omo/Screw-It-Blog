...
<body>              
  ...
  <p>Scroll down to see the sticky effect.</p>
    ...
    <nav class="navbar navbar-expand-lg flex-column flex-md-row d-flex sticky-top" id="navbar">
    ...
    <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
            <a class="dropdown-item" href="OnLoan.php">KITCHEN</a>
    ...
    <li class="nav-item">
         <a class="nav-link" href="AdminArea.php">MY ACCOUNT</a>
    </li>
    <li class="nav-item">
         <a class="nav-link" href="AdminArea.php">BLOGGER AREA</a>
    </li>
    </ul>
